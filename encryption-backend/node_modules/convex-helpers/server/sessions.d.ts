 ...
 */
import type { FunctionArgs, FunctionReference, FunctionReturnType, GenericActionCtx, GenericDataModel } from "convex/server";
import type { Validator } from "convex/values";
import type { BetterOmit, EmptyObject } from "../index.js";
export type SessionId = string & {
    __SessionId: true;
};
export declare const vSessionId: Validator<SessionId>;
